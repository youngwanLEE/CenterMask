...
class ROIMaskHead(torch.nn.Module):
    def __init__(self, cfg, in_channel):
        ...
        self.cfg = cfg.clone()
        self.feature_extractor = make_roi_mask_feature_extractor(cfg, in_channel)
        self.predictor = make_roi_mask_predictor(cfg, in_channel)
...
def build_roi_mask_head(cfg, in_channel):
    return ROIMaskHead(cfg, in_channel)